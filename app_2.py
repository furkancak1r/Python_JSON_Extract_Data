...
for service in data:
    ...
    if parts_raw:
        ...
        part_processed = {
            "MÜŞTERİ ÜNVANI / customer_name": service.get('MÜŞTERİ ÜNVANI / customer_name', None),
            "MÜŞTERİ ŞUBESİ / customer_branch": service.get('MÜŞTERİ ŞUBESİ / customer_branch', None),
            "ARIZA TANIMI": service.get('ARIZA TANIMI', None),
            "SERVİS TÜRÜ / type ": service.get('SERVİS TÜRÜ / type ', None),
            "SRV NUMARASI / serviceNo ": service.get('SRV NUMARASI / serviceNo ', None),
            "code": None,
            "explanation":  None,
            "quantity": None,
            "price": None,
